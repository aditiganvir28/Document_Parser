  ...
  return (
    ...
    <div class="flip-card-inner">
        ...
        <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              <li className="ml-4">
                <Link to="#" className="flex justify-center items-center text-yellow-500 bg-gray-800 hover:text-gray-800 hover:bg-yellow-500 rounded-full transition duration-150 ease-in-out" aria-label="Github">
              ...
              <li className="ml-4">
                <Link to="#" className="flex justify-center items-center text-yellow-500 bg-gray-800 hover:text-gray-800 hover:bg-yellow-500 rounded-full transition duration-150 ease-in-out" aria-label="Linkedin">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
